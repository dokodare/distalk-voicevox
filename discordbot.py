...
voicevox_pitch = os.getenv('VOICEVOX_PITCH', default='0')
voicevox_intonationscale = os.getenv('VOICEVOX_INTONATIONSCALE', default='1')
    ...
    if message.guild.voice_client:
        if not message.author.bot:
            if not message.content.startswith(prefix):
                ...
                mp3url = f'https://api.su-shiki.com/v2/voicevox/audio/?text={text}&key={voicevox_key}&speaker={voicevox_speaker}&pitch={voicevox_pitch}&intonationScale={voicevox_intonationscale}&speed={voicevox_speed}'
